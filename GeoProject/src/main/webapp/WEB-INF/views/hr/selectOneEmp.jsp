			...
			<ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link active" data-bs-toggle="tab"
						data-bs-target="#profile-overview" aria-selected="true" role="tab">사원 정보</button>
				</li>
			...
			<div class="tab-content pt-30">
				...
				<div class="tab-pane fade show active profile-overview"
					...
					<div class="row" style="margin-bottom: 10px;">
						...
						<div class="col-lg-9 col-md-8">
							<fmt:parseDate var="cDate01" value="${vo.emp_birth}" type="date" pattern="yyyy-MM-dd"/>
					...
					<div class="row" style="margin-bottom: 10px;">
						...
						<div class="col-lg-9 col-md-8">
							<fmt:parseDate var="cDate02" value="${vo.emp_hiredate}" type="date" pattern="yyyy-MM-dd"/>
				...
				<div class="tab-pane fade profile-edit pt-3" id="profile-edit"
					...
					<input type="hidden" name="emp_no" value="${vo.emp_no}">
						...
						<div class="row mb-3">
							...
							<div class="col-md-8 col-lg-9">
								<input name="emp_name" type="text" class="form-control"
									id="name" value="${vo.emp_name}" readonly="readonly" style="background-color: silver;">
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-md-8 col-lg-9">
								<fmt:parseDate var="cDate" value="${vo.emp_birth}" pattern="yyyy-MM-dd"/>
								<fmt:formatDate var="emp_birth01" value="${cDate}"/>
								<input name="emp_birth" type="text" class="form-control"
									value="${emp_birth01}" readonly="readonly" style="background-color: silver;">
							</div>
						</div>
...
<!-- 							</div> -->
						...
						<div class="row mb-3">
							...
							<div class="col-md-8 col-lg-9">
								<fmt:parseDate var="cDate" value="${vo.emp_hiredate}" pattern="yyyy-MM-dd"/>
								<fmt:formatDate var="emp_hireDate01" value="${cDate}"/>
								<input name="emp_hiredate" type="text" class="form-control" id="hiredate"
									value="${emp_hireDate01}" readonly="readonly" style="background-color: silver;">
							</div>
						</div>
...
<!-- 					<form action="./modPw.do" method="post"> -->
