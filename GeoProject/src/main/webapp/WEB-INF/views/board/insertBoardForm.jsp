	...
	<main id="main" class="main">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td scope="row">제목</td>
				<td colspan="3">
				<textarea rows="1" cols="10" name="bo_title" placeholder="제목 입력"></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" rowspan="8">
				 <textarea name="bo_content" style="width: 1000px; height: 200px; box-sizing: border-box;" placeholder="내용 입력"></textarea>
				</td>
			</tr>
		</table>
